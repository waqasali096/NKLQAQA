	 ...
	 checkIFSLAAcheived: function(component, event ) {
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {
               ...
               component.set("v.endTime",result.SLA_Expected_Time__c);
                
                if(result.SLA_Response_Time__c!=null && result.SLA_Response_Time__c!=''){
                    ...
                    if(component.get("v.stopUpdate") === false){
                        //this.checkIFSLAAcheived(component, event);
                    }
                } 
            ...
            var timer = setInterval(function() {
              ...
              //  });
                ...
                if(taskAchieved === false){
                    ...
                    var timeDiffrence = new Date(lead.SLA_Expected_Time__c).getTime() - new Date(lead.SLA_Response_Time__c).getTime();
