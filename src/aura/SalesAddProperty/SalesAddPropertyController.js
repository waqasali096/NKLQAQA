({
    doInit : function(component, event, helper) {
        ...
        */
        ...
        helper.callProjects(component, event);
        helper.callUnitType(component, event);
        component.set('v.columnsforOnloadUnit', [
            {label: '',fixedWidth: 40,cellAttributes: { class: { fieldName: 'Unit_Flag__c' } }},
            ...
            {label: 'Theme', fieldName: 'UnitThemeName', type: 'url', wrapText: true ,typeAttributes: {label: {fieldName: 'unitThemeName'}, target: '_blank'},hideDefaultActions: true},
            {label: 'Cluster/Floor', fieldName: 'ClusterName', type: 'url', wrapText: true ,typeAttributes: {label: {fieldName: 'clusterName'}, target: '_blank'},hideDefaultActions: true},
...
$A.enqueueAction(action);
    ...
    handleNext : function(component, event, helper) { 
        ...
        onReset : function(component, event, helper) { 
            ...
            component.set("v.selectedRecentlyAdded", 'NO');
            helper.getUnits(component, helper);
        },
                ...
                component.set('v.listofSelectedUnitIDS' , selectedUnitIds) ; */
                    ...
                    callcreateoffershelper: function(component, event, helper) {
                        ...
                        search : function(component, event, helper) {
                            ...
                            //}else if(!unitType){
                            //    helper.showErrorMsg(component,event,'Please select Unit Type');    
                            //}else{
