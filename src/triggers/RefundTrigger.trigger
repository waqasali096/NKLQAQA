/*
Trigger Name:               RefundTrigger
Class Description:          To manage the refund level trigger automations.
Author:                     Taha Hamid
...
{
    RefundTriggerHandler handler = new RefundTriggerHandler(trigger.new, trigger.old, trigger.newMap, trigger.oldMap, trigger.isInsert, 
