/*
Class Name: CardTrigger
Class Description: Trigger for Card__c object
Author: Karishma Kotian
Created Date: 28th Feb 2022
Updated by: 
Last Update Date:
*/
trigger CardTrigger on Card__c (before insert, before update, after insert, after update, before delete, after delete, after undelete) {
    CardTriggerHandler handler = new CardTriggerHandler(trigger.new, trigger.old, trigger.newMap, trigger.oldMap, trigger.isInsert, 
