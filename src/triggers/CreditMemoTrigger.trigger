trigger CreditMemoTrigger on Credit_Memo__c (after insert, before update) {
    
    CreditMemoTriggerHandler handler = new CreditMemoTriggerHandler(trigger.new, trigger.old, trigger.newMap, trigger.oldMap, trigger.isInsert, 
