...
Class Description:          To manage the content version level trigger automations.
Author:                     Waqas Ali
...
trigger ContentVersionTrigger on ContentVersion (after insert) {
    ContentVersionTriggerHandler handler = new ContentVersionTriggerHandler(trigger.new, trigger.old, trigger.newMap, trigger.oldMap, trigger.isInsert, trigger.isUpdate, trigger.isDelete, trigger.isUndelete);
